				...
				<div id='wrapper'>
					<section id="primary">
						...
						<ul className="contact-info">
							<li className="phone"><a href="tel:502-899-2384" style="background-image: url('../components/img/android-color.png')">(502)899-2384 (work)</a></li>
							<li className="linkedin"><a href="https://www.linkedin.com/in/egraytech/" style="background-image: url('../components/img/linkedin-color.png')">EGrayTech LinkedIn Profile</a></li>
							<li className="mail"><a href="mailto:corgidev@outlook.com?subject=Email from CorgiDev site" style="background-image: url('../components/img/google-color.png')">corgidev@outlook.com</a></li>
							<li className="twitter"><a href="https://twitter.com/intent/tweet?screen_name=egraytech" styel="background-image: url('../components/img/twitter-color.png')">@egraytech</a></li>
							<li className="github"><a href="https://github.com/EGrayTech" target="_blank" rel="noopener noreferrer" style="background-image: url('../components/img/github-color.png');">EGrayTech GitHub Profile</a></li>
						</ul>
					</section>
					...
					<section id="secondary">
						...
						<form id="contactForm" name="contactForm" action="mailto:corgidev@outlook.com?subject=CorgiDev Contact Form" method="post" enctype="text/plain">
							...
							<label for="userMessage">Comments: </label><textarea name="userMessage" cols="40" rows="10" maxlength="1000" id="userMessage" required></textarea>{"\n"}
